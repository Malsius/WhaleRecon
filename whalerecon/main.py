...
def main():
    ...
    parser = argparse.ArgumentParser(add_help=False, allow_abbrev=False, description="Tool used to run AutoRecon in a container and auto generate HTML reports", usage="whalerecon [-h] [-V] -o <output_path> [-v] [autorecon_options]")
